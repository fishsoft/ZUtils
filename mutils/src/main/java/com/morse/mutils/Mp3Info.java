...
public class Mp3Info {
	...
	public String toString() {
		return "Mp3Info [id=" + id + ", title=" + title + ", album=" + album + ", albumId=" + albumId
				+ ", displayName=" + displayName + ", artist=" + artist + ", duration=" + duration + ", size=" + size
...
//	}
//
//	public Mp3Info(long id, String title, String album, long albumId, String displayName, String artist, long duration,
//			long size, String url, String lrcTitle, String lrcSize) {
//		super();
//		this.id = id;
//		this.title = title;
//		this.album = album;
